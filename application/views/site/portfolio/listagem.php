        ...
        <div class="span3 item isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(878px, 0px, 0px); ">
          <div class="picture">
           <?php if($res->img !=''){ ?>
            ...
            <a class="image" href="<?php echo base_url(); ?>portfolio/<?=url_title($res->titulo)?>/<?=$res->id?>" title="<?=$res->titulo;?>"><img src="<?php echo base_url(); ?>uploads/portfolio/<?=$res->img?>" alt="<?=$res->titulo;?>"></a>

             <?php }?>
            <div class="description">
              
              <a href="<?php echo base_url(); ?>portfolio/<?=url_title($res->titulo)?>/<?=$res->id?>" title="<?=$res->titulo;?>">
...
<section class="service-home section-padding">
					<div class="container text-center">
						...
						<!-- /.row -->
							...
							<?php 
		foreach($portfolios->result() as $res) {
							?> 
							<div class="col-sm-3" style="margin-bottom: 50px">
								<div class="service">
								<a class="readmore" href="servicos/em/<?=url_title($res->titulo)?>/<?=$res->id?>">
									<div class="service-thumb-home">
										<img src="<?php echo base_url(); ?>uploads/portfolios_saude/<?=$res->img?>" alt="<?=$res->titulo?>" alt="">
									</div>

									<h3 style="font-size: 19px"><?=$res->titulo?></h3>
									<p style="height: 90px"><?php echo mb_strimwidth($res->resumo, 0, 100, "...");?> </p>
