...
<?php 
			$filename = "uploads/portfolio/".$pagina->img;
     ...
     <div class="sub-page-content" style="margin-top: 30px; margin-bottom: 30px">
        ...
        <div class="container big-font">
            <small style="font-size: 12px">Estou em:
                <a href="<?php echo base_url(); ?>" title=" <?=$pagina->titulo;?>">Home</a> <i style="height: 2px" class="fa fa-chevron-right" aria-hidden="true"></i><a href="<?php echo base_url(); ?>portfolio/" title=" <?=$pagina>titulo;?>"> Portfolio</a> <i style="height: 2px" class="fa fa-chevron-right" aria-hidden="true"></i>
<?=$pagina->titulo;?></small>
            ...
            <?php } ?>
            <p align="justify" ><?=nl2br($pagina->descricao);?></p>
            </div>
        </div>
