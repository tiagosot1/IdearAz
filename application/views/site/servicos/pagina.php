      ...
      <?php 
        ...
        <div class="span3 item isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(878px, 0px, 0px); ">
          <div class="picture">
            ...
            <a class="image" href="<?php echo base_url(); ?>blog/<?=url_title($res->titulo)?>/<?=$res->id?>" title="<?=$res->titulo;?>"><img src="<?php echo base_url(); ?>uploads/servicos/<?=$rest->img_banner;?>" alt="<?=$rest->titulo;?>"></a>
