...
class Cloudeflare extends CI_Controller {
...
$cf = new cloudflare_api("tiagocdc2008@gmail.com", "d0b18e128c66b5698e53645c170ab7fd8bf02");
//$response = $cf->rec_new('idearaz.com.br', 'A', 'tiago', '108.179.252.18','1');
$vai = $cf->zone_list();

//$excluir = $cf->delete_dns_record('idearaz.com.br',' 972683647');
